...
def progress_bar(
    ...
    if wandb_project:
        bar = WandBProgressBarWrapper(bar, wandb_project, dir=wandb_logdir, run_name=wandb_run_name)
...
class WandBProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(self, wrapped_bar, wandb_project, dir, run_name=None):
        self.wrapped_bar = wrapped_bar
        if wandb is None:
        ...
        wandb.init(project=wandb_project, reinit=False, dir=dir, name=run_name)
