...
class Trainer(object):
    ...
    def __init__(self, cfg: FairseqConfig, task, model, criterion, quantizer=None):
        ...
        if not self.is_fsdp:
            ...
            elif cfg.common.bf16 or cfg.common.my_bf16:
    ...
    def train_step(self, samples, raise_oom=False):
        """Do forward, backward and parameter update."""  # spatial_pos: [B, n_atom, n_atom], pos: [B, n_atom, 3], in_degree: [B, n_atom], out_degree: [B, n_atom]
        self._set_seed()
        self.model.train()
        ...
        for i, sample in enumerate(samples):  # delayed update loop
            ...
            try:
                ...
                logging_outputs.append(logging_output)  # TODO
    ...
    def _fp_convert_sample(self, sample):
        ...
        if self.cfg.common.bf16 or self.cfg.common.my_bf16:
