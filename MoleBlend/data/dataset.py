...
class MOLPreprocessedData():
    def __init__(self, dataset_name, dataset_path = "../dataset", seed=42, task_idx=4, cut_length=False):
        super().__init__()

        self.dataset_name = dataset_name
        self.dataset = PYGDatasetLookupTable.GetPYGDataset(dataset_name, seed=seed, dataset_path=dataset_path, task_idx=task_idx, cut_length=cut_length)
        self.setup()
